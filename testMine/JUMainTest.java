...
public class JUMainTest
{
    ...
    {
        World w = new World( worldX, worldY, players, enemies, lis );
        assertEquals( 1, w.distance( 1, 2 ) );
    }


    @Test
    public void worldRunWorld()
    {
        World w = new World( worldX, worldY, players, enemies, lis );
        w.runWorld();
        assertTrue( true );
    ...
    @Test
    public void worldChangePicToAttk()
    {
        World w = new World( worldX, worldY, players, enemies, lis );
        assertTrue( true );
    }
    ...
    @Test
    public void worldChangePicToNull()
    {
        World w = new World( worldX, worldY, players, enemies, lis );
        assertTrue( true );
    }
    ...
    @Test
    public void worldGetXDim()
    {
        World w = new World( worldX, worldY, players, enemies, lis );
        assertEquals( worldX, w.getXDim() );
    }


    @Test
    public void worldGetYDim()
    {
        World w = new World( worldX, worldY, players, enemies, lis );
        assertEquals( worldY, w.getYDim() );
    }
    ...
    {
        return new JUnit4TestAdapter( JUMainTest.class );
    }


    public static void main( String args[] )
    {
        org.junit.runner.JUnitCore.main( "JUMainTest" );
    }
